...
class GameScene2 extends Phaser.Scene {
    ...
    update() {
        ...
        this.distance = Phaser.Math.Distance.Between(this.enemy.x, this.enemy.y, this.player.x, this.player.y);
    ...
    followPlayer() {
        if (this.player.x < this.enemy.x) {
            this.enemy.setVelocityX(-this.speed); // Move para a esquerda
        } 
        else {
            this.enemy.setVelocityX(this.speed); // Move para a direita
        }
        if (this.player.y < this.enemy.y) {
            this.enemy.setVelocityY(-this.speed); // Move para a esquerda
        } 
        else {
            this.enemy.setVelocityY(this.speed); // Move para a direita
        }
    }
